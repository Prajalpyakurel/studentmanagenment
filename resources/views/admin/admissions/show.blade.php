...
@section('content')
    ...
    <p><strong>Total Fee:</strong> Nrs.{{ $admission->total_fee }}</p>
    <p><strong>Remaining Fee:</strong> Nrs.{{ $admission->remaining_fee }}</p>
    <p><strong>Payment History:</strong></p>
    <ul>
        @foreach ($admission->receipts as $receipt)
            <li>
                <strong>Amount:</strong> Nrs.{{ $receipt->amount_received }} |
