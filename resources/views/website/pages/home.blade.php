                ...
                <div class="hero-section-left">
                    <div class="hero-left-content d-flex flex-col">
                        <div class="hero-left-heading text-justify">
                            ...
                            <h1 style="color: #3A53A7;font-weight:600;"><span style="color: #de5fa8">E</span>ntertainment.
                            </h1>
                        </div>
                        ...
                        <div>
                            <a href="{{ route('aboutus') }}"
                                class="text-decoration-none p-3 text-light fw-bold learn-more-home"
    ...
    <div class=" container py-5">
        <div class="row align-items-center">
            ...
            <div class="our-story-left col-lg-6 col-md-12 text-center text-lg-start mb-4 mb-lg-0">
                <img src="{{ asset('our-story.png') }}" alt="Our Story" class="img-fluid"
            ...
            <div class="our-story-right col-lg-6 col-md-12">
                <div class="our-story-content">
                    <p class="text-justify">
                        EEE Innovation Ghar Pvt. Ltd was established on 12 February, 2019 to provide appropriate and
                        advanced
                        ...
                        diversify and become a leading conglomerate in Nepal, developing innovative technologies and
                        applying
                        them across diverse domains. Our highly dedicated and expert IT team provides world-class solutions
                        and
        ...
        <div class="row d-flex">
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="item text-center">
                    ...
                    <p>We build responsive, user-friendly web applications to enhance your online presence and drive
                        business growth.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="item text-center">
                    ...
                    <p>Our digital marketing services help boost brand visibility, increase engagement, and deliver
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="item text-center">
                    ...
                    <p>We build responsive, user-friendly websites to enhance your online presence and drive business
                        growth.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="item text-center">
                    ...
                    <p>Secure your online presence with easy domain registration. Choose a unique name for your website and
            ...
            <div class="col-lg-4 col-sm-6 mb-4">
                <div class="item text-center">
                    ...
                    <p>Ensure your website runs smoothly with reliable maintenance services. From updates to security, we've
                        got you covered!</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card all-courses servcies" style="width:100%; height:30rem;">
                    @if ($training->training_photo)
                        <img src="{{ asset('storage/' . $training->training_photo) }}"
                            alt="{{ $training->training_name }}" width="200px" class="card-img-top">
                    @else
                        No Photo
                    @endif
                    <div class="card-body d-flex flex-col gap-4">
                        ...
                        <h6 class="">Duration:{{ $training->training_duration }}</h5>
                            ...
                            @if ($training->syllabus_pdf)
                                <p class="">Current Syllabus: <a
                                        href="{{ asset('storage/' . $training->syllabus_pdf) }}" target="_blank">View
                                        PDF</a></p>
                            @endif

                            <a href="#" class="btn courses-view"
                                style="background-color:#DC58A4; font-weight:500;">View More</a>
                    </div>
                </div>
            </div>
        @endforeach
    ...
    <section class="course-categories">
        ...
        <div class="category-grid">
            <div class="category-card">
                ...
                <p style="font-size: 1.2rem;">We deliver high-quality, custom websites and applications that drive results
                    and engage users seamlessly.</p>
            </div>

            <div class="category-card">
                <i class="fa-solid fa-chart-line text-dark"></i>
                <h3 class="text-danger">Effective Digital Marketing</h3>
                <p style="font-size: 1.2rem;">Boost your brand’s online presence with our data-driven SEO, social media,
                    and PPC marketing strategies.</p>
            </div>
            ...
            <div class="category-card">
                ...
                <p style="font-size: 1.3rem;">Learn directly from seasoned IT experts with in-depth industry experience.
                </p>
            </div>
            <div class="category-card">
