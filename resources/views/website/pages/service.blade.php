        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card all-courses servcies" style="width:100%; height:24rem;">
                    <img src="{{ asset('img-card.png') }}" class="card-img-top" alt="Web Development">
            ...
            <div class="col-md-4 col-sm-6 mb-4">
                <div class="card all-courses servcies" style="width:100%; height:24rem;">
                    ...
                    <div class="card-body d-flex flex-col gap-4">
                        ...
                        <a href="{{route('MobileDevelopmentService')}}" class="btn courses-view" style="background-color:#DC58A4; font-weight:500;">View More</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 mb-4">
